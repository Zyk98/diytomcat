package cn.diy.diytomcat.watcher;

import cn.diy.diytomcat.util.Constant;
import cn.diy.diytomcat.catalina.Host;
...
public class WarFileWatcher {
    ...
    public WarFileWatcher(Host host) {
        this.monitor = WatchUtil.createAll(cn.diy.diytomcat.util.Constant.webappsFolder, 1, new Watcher() {
