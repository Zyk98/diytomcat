...
public class JspUtil {
    ...
    public static void compileJsp(Context context, File file) throws JasperException {
        ...
        String workPath = new File(cn.diy.diytomcat.util.Constant.workFolder, subFolder).getAbsolutePath() + File.separator;
    ...
    public static String getServletPath(String uri, String subFolder) {
        ...
        File tempFile = FileUtil.file(cn.diy.diytomcat.util.Constant.workFolder, subFolder, tempPath);
