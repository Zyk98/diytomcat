...
import cn.diy.diytomcat.http.StandardSession;
...
public class SessionManager {
    //存储session
    private static Map<String, cn.diy.diytomcat.http.StandardSession> sessionMap = new ConcurrentHashMap<>();
    ...
    public static HttpSession getSession(String jsessionid, cn.diy.diytomcat.http.Request request, cn.diy.diytomcat.http.Response response) {
        /**
         * 获取session的主逻辑
        ...
        if (null == jsessionid) {
            ...
            cn.diy.diytomcat.http.StandardSession currentSession = sessionMap.get(jsessionid);
    ...
    private static void createCookieBySession(HttpSession session, cn.diy.diytomcat.http.Request request, cn.diy.diytomcat.http.Response response) {
    ...
    private static HttpSession newSession(Request request, Response response) {
        ...
        cn.diy.diytomcat.http.StandardSession session = new cn.diy.diytomcat.http.StandardSession(sid, servletContext);
