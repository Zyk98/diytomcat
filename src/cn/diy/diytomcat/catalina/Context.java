...
import cn.diy.diytomcat.exception.WebConfigDuplicatedException;
import cn.diy.diytomcat.http.ApplicationContext;
import cn.diy.diytomcat.http.StandardServletConfig;
import cn.diy.diytomcat.util.ContextXMLUtil;
import cn.diy.diytomcat.watcher.ContextFileChangeWatcher;
import cn.diy.diytomcat.classloader.WebappClassLoader;
...
public class Context {
    ...
    private cn.diy.diytomcat.watcher.ContextFileChangeWatcher contextFileChangeWatcher;
    ...
    private void init() {
        ...
        try {
            checkDuplicated();
        } catch (cn.diy.diytomcat.exception.WebConfigDuplicatedException e) {
    ...
    private void checkDuplicated(Document d, String mapping, String desc) throws cn.diy.diytomcat.exception.WebConfigDuplicatedException {
        ...
        for (int i = 0; i < contents.size() - 1; i++) {
            ...
            if (contentPre.equals(contentNext)) {
                throw new cn.diy.diytomcat.exception.WebConfigDuplicatedException(StrUtil.format(desc, contentPre));
            }
        }
